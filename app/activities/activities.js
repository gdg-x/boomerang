...
.controller('ActivitiesController', function (Config, NavService) {
    ...
    var activityList = {
        techTalks: {
            ...
            color: 'purple',
            icon: '/boomerang/app/images/icons/ic_mic_48px.svg'
        },
        roundTables: {
            name: 'Round Tables',
            description: 'Free-form, community-focused events where all attendees can raise topics for discussion.',
            color: 'darkBlue',
            icon: '/boomerang/app/images/icons/ic_local_pizza_48px.svg'
        },
        codeLabs: {
            name: 'Code Labs',
            ...
            color: 'green',
            icon: '/boomerang/app/images/icons/ic_code_48px.svg'
        },
        devFests: {
            name: 'Dev Fests',
            ...
            color: 'deepBlue',
            icon: '/boomerang/app/images/icons/ic_event_48px.svg'
        },
        appClinics: {
            name: 'App Clinics',
            ...
            color: 'yellow',
            icon: '/boomerang/app/images/icons/ic_local_hospital_48px.svg'
        },
        panels: {
            name: 'Panels',
            ...
            color: 'lightPurple',
            icon: '/boomerang/app/images/icons/ic_people_48px.svg'
        },
        hackathons: {
            name: 'Hackathons',
            ...
            color: 'red',
            icon: '/boomerang/app/images/icons/ic_timer_48px.svg'
        },
        designSprints: {
            name: 'Design Sprints',
            description: 'Intense, focused, collaborative brainstorming events where product design is key. ' +
                ...
                'and testing.',
            color: 'pink',
            icon: '/boomerang/app/images/icons/ic_directions_run_48px.svg'
        }
    };
